...
namespace Ugarit\Pail\Console\Commands;

use Heritage\Console\Command;
use Heritage\Process\Exceptions\ProcessTimedOutException;
use Ugarit\Pail\File;
use Ugarit\Pail\Guards\EnsurePcntlIsAvailable;
use Ugarit\Pail\Options;
use Ugarit\Pail\ProcessFactory;
...
class PailCommand extends Command
{
    ...
    public function handle(ProcessFactory $processFactory): void
    {
        ...
        try {
            $processFactory->run($this->file, $this->output, $this->ugarit->basePath(), $options);
